...
"[project]/Desktop/email-traking sainty/email-tracking-next/app/api/templates/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        // ✅ Fetch Templates
        const templates = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$email$2d$traking__sainty$2f$email$2d$tracking$2d$next$2f$lib$2f$sanity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanity"].fetch(`*[_type == "emailTemplate" ${filter}]
        ...
        // ✅ Total Count
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$email$2d$traking__sainty$2f$email$2d$tracking$2d$next$2f$lib$2f$sanity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanity"].fetch(`count(*[_type == "emailTemplate" ${filter}])`, {
            search: `${search}*`
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__633ce241._.js.map