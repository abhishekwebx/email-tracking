...
async function POST(req) {
    ...
    try {
        // UPDATE Draft
        if (id) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$email$2d$traking__sainty$2f$email$2d$tracking$2d$next$2f$lib$2f$sanity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanity"].patch(id).set({
                to,
                subject,
                body: message,
                senderName,
        ...
        // CREATE Draft
        const draft = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$email$2d$traking__sainty$2f$email$2d$tracking$2d$next$2f$lib$2f$sanity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanity"].create({
            _type: "emails",
            to,
            subject,
            body: message,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb09fda3._.js.map