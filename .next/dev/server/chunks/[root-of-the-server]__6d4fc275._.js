...
async function PUT(req, { params }) {
    ...
    const cleanId = params.id.split("?")[0];
    await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$email$2d$traking__sainty$2f$email$2d$tracking$2d$next$2f$lib$2f$sanity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanity"].patch(cleanId).set(body).commit();
    const updatedEmail = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$email$2d$traking__sainty$2f$email$2d$tracking$2d$next$2f$lib$2f$sanity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanity"].fetch(`*[_type == "emails" && _id == $id][0]`, {
        id: cleanId
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$email$2d$traking__sainty$2f$email$2d$tracking$2d$next$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d4fc275._.js.map