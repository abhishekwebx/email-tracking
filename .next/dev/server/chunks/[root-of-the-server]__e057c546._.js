...
async function POST(req) {
    try {
        ...
        let user;
        if (isEmail) {
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sanity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanity"].fetch(`*[_type == "user" && email == $email][0]`, {
            ...
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sanity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanity"].fetch(`*[_type == "user" && userId == $userId][0]`, {
                userId: numericId
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e057c546._.js.map