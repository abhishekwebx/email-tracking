...
"[project]/app/sanity/client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$sanity$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/sanity/client.ts [app-route] (ecmascript)");
;
;
;
;
async function POST(req) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$sanity$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].fetch(`*[_type == "user" && (email == $id || userId == $id)][0]`, {
            id: identifier
        });
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae8a7b75._.js.map